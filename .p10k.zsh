# Generated by Powerlevel10k configuration wizard on 2020-04-24 at 00:02 MSK.
...
() {
  ...
  function my_git_formatter() {
    ...
    local vcs_color=${clean}
    (( VCS_STATUS_NUM_UNSTAGED   )) && vcs_color=${modified}
    (( VCS_STATUS_NUM_UNTRACKED  )) && vcs_color=${untracked}
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      res+="${vcs_color}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}"
    ...
    (( VCS_STATUS_COMMITS_BEHIND )) && res+="${(g::)POWERLEVEL9K_VCS_COMMITS_BEHIND_ICON}"
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+="${(g::)POWERLEVEL9K_VCS_UNSTAGED_ICON}"
    # ?42 if have untracked files. It's really a question mark, your font isn't broken.
    # See POWERLEVEL9K_VCS_UNTRACKED_ICON above if you want to use a different icon.
    # Remove the next line if you don't want to see untracked files at all.
    (( VCS_STATUS_NUM_UNTRACKED  )) && res+="${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}"
